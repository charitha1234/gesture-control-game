...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='weights/yolov3.cfg', help='cfg file path')
    parser.add_argument('--data', type=str, default='hand.data', help='hand.data file path')
    ...
    parser.add_argument('--cam', action='store_true', help='use cam')
